                                                    ...
                                                    <div class="modal-header">
                                                        ...
                                                        <form action="task_update.php?taskId=<?= $task['task_id']?>" method="post">
                                                            ...
                                                            <div class="modal-footer">                                                          
                                                                ...
                                                                <button type="button" class="btn btn-secondary" id="pendingtask" data-bs-dismiss="modal">Set as In Progress</button>
                                                                <button type="button" class="btn btn-success" id="completetask" data-bs-dismiss="modal">Complete Task</button>
                                                            </div>
                                                </div>
                                                        </form>
