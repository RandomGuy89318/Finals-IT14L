<?php
    ...
    $count = searchtasksCount($searchText);
?>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody >
                                    <?php
                                        ...
                                        $gettasks=searchtasks($searchText);
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?=date("M d, Y g:i A", strtotime ($task['task_completed']))?></td>
            ...
            <div class="modal-content">
                ...
                <form action="task_create.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="" class="form-label">Quantity</label>
                            <input type="number" class="form-control"  name="taskdescription" id="taskdescription" min="0" step="0.01" required>
                        </div>
                    </div>
